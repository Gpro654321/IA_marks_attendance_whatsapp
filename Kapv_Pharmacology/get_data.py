...
for (details_row, 
    ...
    if df_ia_practical.shape == (0,1):
        # if practical internal assessments were not conducted
        print("NO PRACTICAL EXAMS WERE CONDUCTED")
        ia_practical_marks_frac = 'NA'
    ...
    test_caption = ("Dear Parent,\n" +
                    ...
                    "contains the performance evaluation of [son/daughter] in the Department of Pharmacology."+
                    "\n\n"+
                    "HOD of Pharmacology,\n"+
